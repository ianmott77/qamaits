...
pub struct ServerConfig{
    ...
    pub tls_cert: String,
    pub hostname: String,
    pub front_end_directory: String,
    pub front_end_repository: String,
    pub front_end_build_directory: String,
    pub front_end_build: String,
    pub repository_key: String,
    pub front_end_install_script: Vec<String>,
    pub front_end_build_script: Vec<String>
}
